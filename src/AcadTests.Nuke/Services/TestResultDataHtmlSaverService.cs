...
/// </summary>
public class TestResultDataHtmlSaverService
{
    /// <summary>
    /// Initialize a new instance of <see cref="TestResultDataHtmlSaverService"/>
    /// </summary>
    public static TestResultDataHtmlSaverService Initialize() => new();
