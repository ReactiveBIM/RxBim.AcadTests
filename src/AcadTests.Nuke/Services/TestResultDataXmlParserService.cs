...
/// </summary>
public class TestResultDataXmlParserService
{
    /// <summary>
    /// Initialize a new instance of <see cref="TestResultDataXmlParserService"/>
    /// </summary>
    public static TestResultDataXmlParserService Initialize() => new();
